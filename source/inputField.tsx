/**
* @description
* Version of Ink >4 is broken, for version 3.2 copied input code as is from..
...
export function UncontrolledTextInput({
	...
	console.log('A', isFocused);

	return <TextInput {...props} value={value} onChange={setValue} focus={isFocused} />;
}